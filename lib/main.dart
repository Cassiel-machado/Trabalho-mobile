...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: "Bandeiras Trabalho Mobile",
      home: Scaffold(
        backgroundColor: Colors.black,
        appBar: AppBar(
          title: Center(
            child: Text(
              "Cassiel Machado - Trabalho Mobile",
              style: TextStyle(
                color: Colors.white,
              ),
            ),
    ...
    Text("Trabalho realizado por cassiel da rosa machado RA:007546");
  }
}
...
class _BandeirasState extends State<Bandeiras> {
  //fizemos um script coletivo da turma para ser mais rapido
  ...
  String siglaBandeiras = "tv";
  int siglaAleatoria = Random().nextInt(1);
    ...
    return Column(
      children: [
        ...
        OutlinedButton(onPressed: (){setState(() {
          color: Color.alphaBlend(Colors.red, Colors.cyan);
          siglaAleatoria = Random().nextInt(333);
